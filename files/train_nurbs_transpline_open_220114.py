...
from NurbsNet_220114 import nurbs_world, zeroUpsamplingby4
...
#         if (train_it % 87) == 0:
#             AProb += AProbSum / config.batch_size
#             BProb += BProbSum / config.batch_size
#             #if (train_it + 1) % 36 == 0:
#             print("A probility : {0} B Probability : {1}".format(AProb, BProb))
        ...
        output = nurbs(output)
            # print("nurbsA(output) : ", output.size())
