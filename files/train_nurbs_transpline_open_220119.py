...
# # 일부(nurbs_world.mlpSoftmax 등)가 Backpropagation 과정으로 학습되는지 확인
...
#         inputGC = torch.randn(992, 800,2, requires_grad=True, dtype=torch.double).cuda()
#         print('\nTransformer.mlpSoftmax gradcheck : ', torch.autograd.gradcheck(Transformer.mlpSoftmax, inputGC))
